  ...
  return (
    <div className="relative w-full h-screen bg-black flex flex-col items-center justify-center text-white font-sans">
      ...
      <motion.div
        ...
        animate={{ opacity: [0, 1, 0], scale: [0, 1, 0], y: -5 }}
        transition={{
          delay: 3,
          duration: 1.5,
          ease: "easeOut",
      ...
      <motion.div
        initial={{ opacity: 0, y: -87 }}
        animate={{ opacity: 2, y: -87 }}
        transition={{ delay: 0.3, duration: 5, ease: "backIn" }}
        className="mt-12 text-center"
      >
        <p className="text-lg font-medium">
          <strong>Voting Link</strong> is on its way. <br />
          Please check your Inbox. You may need to refresh Inbox. <br />
